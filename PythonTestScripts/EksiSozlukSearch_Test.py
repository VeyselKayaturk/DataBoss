...
class EksiSozlukSearch(unittest.TestCase):
        ...
        def test_eksi_sozluk(self):
            ...
            openedOptions[0].click()  # select Eksisozluk from opened slectionbox
            time.sleep(3)
            ...
            self.driver.find_element(By.XPATH, '/html/body/div[1]/div/section/div[1]/div[2]/div[2]/div/div/div/div[2]/span/span').click()
            time.sleep(3)

            # search specific tag/index from search result page
            self.driver.find_element(By.XPATH, '/html/body/div[1]/div/section/div[1]/div[2]/div[2]/div/div[1]/div/div[2]/span/input').send_keys('25 mart 2019 dolar kuru')

            self.driver.find_element(By.XPATH, '//*[@id="search-tab"]/div[1]/div/div[2]/span/span').click()
            time.sleep(3)

            contentisExist = self.driver.find_element_by_xpath('//*[@id="content-tab"]/div/div/div[2]/div/div[1]/div/div/div/div/div[1]/div[2]/div[1]/div/div[1]')
            print(contentisExist.text)
            assert contentisExist.text == '25 mart 2019 dolar kuru'
